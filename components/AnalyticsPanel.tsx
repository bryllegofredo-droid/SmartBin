...
import { WEEKLY_VOLUME, DONUT_DATA, PICKUP_LOGS } from '../constants';
...
const AnalyticsPanel: React.FC = () => {
  return (
    <div className="flex flex-col gap-6">
      ...
      {/* Alert Card */}
      <div className="flex flex-col gap-4 p-5 rounded-xl bg-surface-light dark:bg-surface-dark border border-gray-200 dark:border-slate-800 shadow-sm">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h3 className="text-sm font-bold text-slate-900 dark:text-white">Critical Level Warning</h3>
            <p className="text-xs text-slate-500 dark:text-slate-400">Bin #402 is at 96% capacity</p>
          </div>
        </div>
        <button className="w-full flex items-center justify-center gap-2 h-9 px-4 rounded-lg bg-primary text-white text-sm font-medium hover:bg-blue-600 transition-colors">
      ...
      {/* Analytics Card */}
      <div className="flex flex-col p-5 rounded-xl bg-surface-light dark:bg-surface-dark border border-gray-200 dark:border-slate-800 shadow-sm flex-1">
      ...
      {/* Recent Pickups List */}
      <div className="flex flex-col rounded-xl bg-surface-light dark:bg-surface-dark border border-gray-200 dark:border-slate-800 shadow-sm overflow-hidden">
