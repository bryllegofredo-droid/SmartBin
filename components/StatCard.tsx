...
const StatCard: React.FC<StatCardProps> = ({ stat, isAlert }) => {
  return (
    <div className={`flex flex-col p-5 rounded-xl bg-surface-light dark:bg-surface-dark border border-gray-200 dark:border-slate-800 shadow-sm relative overflow-hidden group ${isAlert ? 'border-l-4 border-l-red-500' : ''}`}>
